...
print("interger division: ", intergerDivisionResult)
...
let double20: Double = 3
let divisionResult: Double = double10/double20
print("division double: " , divisionResult)
print("When we used type Int, we got answer in Integer and it doesnt add decimal points. But when we used type Double we got the exact answer that we wanted.")
...
print("An even number will give 0 as a remiander while odd will give 1 as a remainder.")
