...
var favoriteBook = Book(title: "The song of Achilles", author: "Madeline Miller", pages: 416 , price: 375)
...
var firstLaptop = Laptop(yearPurchase: 2023)
var secondLaptop = Laptop(yearPurchase: 2025)

print("First Laptop: \(firstLaptop)")
print("Second Laptop: \(secondLaptop)")
/*:
...
struct Height{
    ...
    init(centimetes: Double){
        self.heightInCentimeters = centimetes
        self.heightInInches = centimetes / 2.54
    }
}
...
var myHeight = Height(centimetes: 152)
