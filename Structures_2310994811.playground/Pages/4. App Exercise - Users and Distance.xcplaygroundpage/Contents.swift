...
var seerat = User(name: "Seerat Sharma", age: 19, height: 152, weight: 55.4, activityLevel: 10)
print(seerat.name, seerat.age, seerat.height, seerat.weight, seerat.activityLevel)
...
var miles = Distance(meters: 900)
print("feet: \(miles.feet)")
