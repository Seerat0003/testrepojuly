...
struct User {
    ...
    static var currentUser: User = User(userName: "Seerat Sharma",email: "isharmaseerat13@gmail.com", age: 19)
...
print("name: ",User.currentUser.userName, "\nemail: ", User.currentUser.email, "\nage: ", User.currentUser.age)
 ...
 */
let newUser = User(userName: "John Doe", email: "johndoe@gmail.com", age: 25)
