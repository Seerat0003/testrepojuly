...
var myRectangle = Rectangle(width: 12, height: 20)
...
struct Height {
    var heightInInches: Double {
        didSet{
            var expectedHeightInCentimeters: Double = heightInInches * 2.54
            if heightInCentimeters != expectedHeightInCentimeters {
                heightInCentimeters = expectedHeightInCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double{
        didSet{
            var expectedHeightInInches: Double = heightInCentimeters/2.54
